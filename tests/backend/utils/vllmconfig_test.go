...
func TestCalculateMaxTokenConfig(t *testing.T) {
	...
	config := utils.CalculateMaxTokenConfig(model, gpu)
...
func TestCalculateBalancedConfig(t *testing.T) {
	...
	config := utils.CalculateBalancedConfig(model, gpu)
...
func TestCalculateVLLMConfig(t *testing.T) {
	...
	config, model, err := utils.CalculateVLLMConfig(params)
	if err != nil {
...
func TestCalculateVLLMConfigSmallMemory(t *testing.T) {
	...
	config, _, err := utils.CalculateVLLMConfig(params)
	if err != nil {
		t.Fatalf("CalculateVLLMConfig failed: %v", err)
	}
	...
	config, _, _ = utils.CalculateVLLMConfig(params)
